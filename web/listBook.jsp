...
<html>
    <head>
        ...
        <script>
            function doAddContain(bookId, userId) {
                window.location.href = 'contain?bookId=' + bookId + '&userId=' + userId;
            }
        </script>
    </head>
    <body>
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top">
                <div class="nav-left">
                    ...
                    <c:if test="${sessionScope.acc.roleId == 2}">
                        ...
                        <a class="nav-link active" href="bookCase?userId=${sessionScope.acc.userId}">My Bookcase</a>
                    </c:if>
                </div>
                <div class="nav-fill">
                        ...
                        <c:forEach items="${listBook}" var="b">
                            <div class="card">
                                ...
                                <p>
                                    ...
                                    <button onclick="doAddContain(${b.bookId}, ${sessionScope.acc.userId})">Add to Bookcase</button>
                                </p>
                            </div>
                        </c:forEach>
                    </div>
